...
export const TestSelectors = {
  ...
  HEADER_USER_MENU_PROFILE_BUTTON: "header-user-menu-profile",
  HEADER_USER_MENU_NOTIFICATIONS_BUTTON: "header-user-menu-notifications",
  HEADER_USER_MENU_SECURITY_BUTTON: "header-user-menu-security",
  ...
  INPUT: {
    ...
    CMS_PAGE_CREATE_PARENT_ID: "input--parentId",
    CMS_PAGE_EDIT_SLUG: "input--slug",
    CMS_PAGE_EDIT_STATUS: "input--status",
    CMS_PAGE_EDIT_TEMPLATE: "input--template",
    CMS_PAGE_EDIT_PARENT_ID: "input--parentId",
    CMS_PAGES_STATUS_FILTER: "select-cms-pages-status-filter",
  },
  FORM: {
  ...
  TAB: {
    ...
    USER_OIDC_IDENTITIES: "tab-user-oidc-identities",
